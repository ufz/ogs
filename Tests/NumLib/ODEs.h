...
// ODE 1 //////////////////////////////////////////////////////////
class ODE1 final
        : public NumLib::ODESystem<NumLib::ODESystemTag::FirstOrderImplicitQuasilinear,
...
public:
    ...
    void assembleJacobian(const double /*t*/, const GlobalVector &/*x*/, GlobalVector const& /*xdot*/,
                          const double dxdot_dx,  const GlobalMatrix& M,
                          const double dx_dx, const GlobalMatrix& K,
...
{
public:
    void assemble(const double t, GlobalVector const& x_curr,
                  GlobalMatrix& M, GlobalMatrix& K, GlobalVector& b) override
    {
    ...
    void assembleJacobian(const double t, const GlobalVector& x_curr, GlobalVector const& xdot,
                          const double dxdot_dx, GlobalMatrix const& M,
                          const double dx_dx, GlobalMatrix const& K,
                          GlobalMatrix &Jac) override
    {
