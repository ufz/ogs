...
# %% [markdown]
# The following figures illustrate the distributions of displacement, horizontal stress, and equivalent plastic strain at the end of the simulation. In comparison with elastic deformation, displacement and stress exhibit noticeable changes.
...
# %% [markdown]
# The following figures present the profiles of horizontal stress, $\sigma_{xx}$, and vertical stress, $\sigma_{yy}$ along the bottom boundary. The stress variations near the tunnel are clearly significant.
