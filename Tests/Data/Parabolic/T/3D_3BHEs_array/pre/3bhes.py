...
import pandas as pd
# %% network
btes = nwk.network(fluids=['water'], T_unit='K', p_unit='bar', h_unit='kJ / kg', T_range=[273.25, 373.15], p_range=[1, 20], h_range=[1, 1000])
...
sp_bhe1, sp_bhe2, sp_bhe3,
bhe1_mg, bhe2_mg, bhe3_mg,
mg_cons, cons_fc)
...
y = np.array([0.47782539, 0.47725723, 0.47555274, 0.47271192, 0.46873478,
  ...
  0.4220905, 0.40907762, 0.39600986, 0.38180578, 0.36646537,
...
#bhes
bhe1.set_attr(D=0.02733,L=100,ks=0.001)
bhe2.set_attr(D=0.02733,L=100,ks=0.001)
bhe3.set_attr(D=0.02733,L=100,ks=0.001)

#consumer
cons.set_attr(D=0.2,L=20,ks=0.001)
