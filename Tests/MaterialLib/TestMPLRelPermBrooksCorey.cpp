...
TEST(MaterialPropertyLib, RelPermBrooksCorey)
{
    ...
    // s_L = 0.012 (s_eff ~= 0.002) lies in the interior dry band where value()
    // clamps k_rel to min_relative_permeability_; the derivative must be zero
    // there (the unclamped formula would give ~1.1e-7).
    std::array<double, 17> ref_saturation = {
        -0.01, 0.00, 0.01, 0.012, 0.02, 0.04, 0.10, 0.20, 0.40,
        0.60,  0.80, 0.90, 0.96,  0.98, 0.99, 1.00, 1.01};

    std::array<double, 17> ref_k_rel_L = {
        1.0000000000E-09, 1.0000000000E-09, 1.0000000000E-09, 1.0000000000E-09,
        2.7123199126E-08, 1.7636064574E-06, 1.1467333635E-04, 1.9615735463E-03,
        3.0156880778E-02, 1.4540473747E-01, 4.4088351375E-01, 6.9346243084E-01,
        8.8856788446E-01, 9.6177504114E-01, 1.0000000000E+00, 1.0000000000E+00,
        1.0000000000E+00};

    std::array<double, 17> ref_dk_rel_L_ds_L = {
        0.0000000000E+00, 0.0000000000E+00, 0.0000000000E+00, 0.0000000000E+00,
        1.0306815668E-05, 2.2339015126E-04, 4.8417630905E-03, 3.9231470925E-02,
        2.9383627425E-01, 9.3650508877E-01, 2.1207055092E+00, 2.9608508283E+00,
        3.5542715378E+00, 3.7677785117E+00, 0.0000000000E+00, 0.0000000000E+00,
        0.0000000000E+00};
