...
{{< figure src="BHE_network.png" width="200" caption="Pipeline network model in TESPy" >}}
...
{{< figure src="BHE_PipeNetwork_feature_workflow.png" width="100" caption="Work flow of the model with BHEs coupled with a pipe network" >}}
