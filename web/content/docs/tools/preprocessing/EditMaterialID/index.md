...
1. In this example we compress/condense the list of material IDs.
...
<p align='center'>
 <img src = newID.png width = "60%" height = "60%" alt="Material ID replacement visualization"> <img src = condense.png width = "60%" height = "60%" alt="Material ID condensation visualization">
</p>
<p align = "center">
