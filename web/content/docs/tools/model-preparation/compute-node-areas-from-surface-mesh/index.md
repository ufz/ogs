...
The following steps were performed to obtain the example data:
 ...
 1. The hexahedral example domain was created by [generateStructuredMesh]({{< ref "structured-mesh-generation">}}) `generateStructuredMesh --no-boundary-meshes -o hex_6x7x3.vtu -e hex --lx 6 --ly 7 --lz 3`.
