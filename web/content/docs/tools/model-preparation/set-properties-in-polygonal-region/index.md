...
![Shows the input mesh with the material ID 0 (red). Furthermore, the input polygon is sketched.](ResetPropertiesInPolygonalRegion-before.png)

![Shows the result. The material ids for the mesh cells have at least one node within the polygonal region changed to the value 1 and are colored now in blue.](ResetPropertiesInPolygonalRegion-result.png)
...
was generated by the following command:](Example2.png)
