...
{{< figure src="pipe_flow_3d_model.png" caption="Single pipe flow model" >}}
...
{{< figure src="T_out_comparison.png" caption="Comparison with analytical solution results" >}}

{{< figure src="absolute_error_fluid_T_30d.png" caption="Distributed temperature of fluid and absolute error" >}}
