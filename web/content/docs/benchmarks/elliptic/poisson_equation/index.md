...
The project file is
[`square_1e3_poisson_sin_x_sin_y.prj`]({{% data-url "Elliptic/square_1x1_SteadyStateDiffusion_Python/square_1e3_poisson_sin_x_sin_y.prj" %}}). It describes the
...
$Q$ is in a [Python
script]({{% data-url "Elliptic/square_1x1_SteadyStateDiffusion_Python/sin_x_sin_y_source_term.py" %}}).
