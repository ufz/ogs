...
note = "`pip install --pre --index-url https://gitlab.opengeosys.org/api/v4/projects/120/packages/pypi/simple ogs`"
...
note = "Download and run .squashfs-file with [Apptainer](/docs/userguide/basics/container/)"
