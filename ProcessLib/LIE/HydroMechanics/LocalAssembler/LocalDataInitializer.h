        ...
        for (unsigned i = 0; i < involved_varIDs.size(); i++)
        {
            ...
            for (int var_comp_id = 0; var_comp_id < n_var_comp; var_comp_id++)
            {
                ...
                for (unsigned k = 0; k < n_var_element_nodes; k++)
                {
                    ...
                    auto global_index =
                        dof_table_.getGlobalIndex(l, var_id, var_comp_id);
