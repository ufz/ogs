...
template <typename T>
struct RandomFieldMeshElementParameter final : public Parameter<T>
{
    RandomFieldMeshElementParameter(std::string const& name_,
                                    MeshLib::Mesh& mesh,
                              ...
                              SpatialPosition const& pos) const override
    {
        ...
        {
            OGS_FATAL(
                "Trying to access a RandomFieldMeshElementParameter but "
                "the element id is not specified.");
        }
