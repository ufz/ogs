...
configure_file(
    ${PROJECT_SOURCE_DIR}/web/hugo.toml.in ${OGS_WEB_WORKSPACE_DIR}/hugo.toml
    @ONLY
)
configure_file(
    ${PROJECT_SOURCE_DIR}/web/package.json.in
    ${OGS_WEB_WORKSPACE_DIR}/package.json @ONLY
)
configure_file(
    ${PROJECT_SOURCE_DIR}/web/tailwind.config.js.in
...
add_custom_target(
    ...
    COMMAND
        ...
        -DSOURCE_DIR=${PROJECT_SOURCE_DIR} -DBINARY_DIR=${PROJECT_BINARY_DIR} -P
        ${PROJECT_SOURCE_DIR}/scripts/cmake/web/GenerateWebStatsData.cmake
    COMMAND yarn
    COMMAND yarn build
