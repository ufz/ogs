...
execute_process(
    COMMAND ${WRAPPER_COMMAND} ${WRAPPER_ARGS} ${UV_RUN_ARGS} ${EXECUTABLE}
            ${EXECUTABLE_ARGS}
    WORKING_DIRECTORY ${WORKING_DIRECTORY}
    RESULT_VARIABLE EXIT_CODE
    OUTPUT_VARIABLE LOG
    ERROR_VARIABLE LOG ECHO_OUTPUT_VARIABLE ECHO_ERROR_VARIABLE COMMAND_ECHO
                   STDOUT
)
...
if(TEST_COMMAND_IS_EXPECTED_TO_SUCCEED)
    if(EXIT_CODE STREQUAL "0")
        ...
        # expected: success, actual: failure use default settings
    endif()
else()
    if(EXIT_CODE STREQUAL "0")
        ...
        if(DEFINED ENV{CI})
            set(TEST_LOG_DIR
                "${LOG_ROOT}/command_succeeded_but_was_expected_to_fail"
            )
        endif()
    else()
