    ...
    MathLib::Point3d const& q, MathLib::Point3d const& r)
{
    ...
    else
    {
        ...
        center_ = two_pnts_sphere.getCenter();
    }
}
...
: radius_(-1), center_(0,0,0)
{
    ...
    center_ = bounding_sphere.getCenter();
