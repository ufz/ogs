...
public:
    ...
    /**
    * Based on a 2D triangle-or quad mesh this method creates a 3D mesh with a
    given number of prism- or hex-layers
    * \param mesh The triangle/quad mesh that is the basis for the new prism/hex
    mesh
    ...
    */
    static MeshLib::Mesh* createStaticLayers(
    ...
    /**
     * Maps the elevation of nodes of a given 2D mesh according to the raster.
     * At locations where no information is given, node elevation is set to
