    ...
    std::vector<std::unique_ptr<ParameterLib::ParameterBase>>& parameters)
{
    ...
    auto& dry_thermal_conductivity =
        ParameterLib::getNamedOrCreateInlineParameter(
            ...
            dry_thermal_conductivity_parameter_name, parameters, property_name,
            "dry_thermal_conductivity", "dry_inline");
    ...
    auto& wet_thermal_conductivity =
        ParameterLib::getNamedOrCreateInlineParameter(
            ...
            wet_thermal_conductivity_parameter_name, parameters, property_name,
            "wet_thermal_conductivity", "wet_inline");
