...
/// Liquid water enthalpy in Region4 curve
...
struct WaterLiquidEnthalpyIAPWSIF97Region4 final : public Property
{
    ...
    /// \return The liquid water enthalpy in Region4 curve.
    PropertyDataType value(VariableArray const& variable_array,
                           ParameterLib::SpatialPosition const& pos,
                           double const t, double const dt) const override;
    /// \return The derivative of liquid water enthalpy in Region4 curve with
