...
{
    std::array<double, ShapeFunction::DIM> const center =
        ShapeFunction::getReferenceElementCenter();

    MathLib::WeightedPoint center_pt(center, 1.0);
    std::vector<MathLib::WeightedPoint> points{std::move(center_pt)};
