...
public:
	...
	{
		amuxCRSParallelOpenMP(d, MatrixBase<FP_TYPE,IDX_TYPE>::_n_rows, CRSMatrix<FP_TYPE,IDX_TYPE>::_row_ptr, CRSMatrix<FP_TYPE,IDX_TYPE>::_col_idx, CRSMatrix<FP_TYPE,IDX_TYPE>::_data, x, y);
	}
};
